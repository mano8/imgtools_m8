...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "provider",
            sa.Enum("PASSWORD", "GOOGLE", name="authprovidertype"),
            nullable=False,
        ),
        sa.Column(
        ...
        sa.Column(
            "avatar", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        ...
        sa.Column(
            "oauth_user_id", sqlmodel.sql.sqltypes.AutoString(length=256), nullable=True
        ),
        sa.Column(
            "telegram_id", sqlmodel.sql.sqltypes.AutoString(length=256), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_auth_api_key_user_id"), "auth_api_key", ["user_id"], unique=False
    )
    op.create_table(
        "auth_client_session",
        sa.Column(
        ...
        sa.Column(
            "jwt_jti", sqlmodel.sql.sqltypes.AutoString(length=128), nullable=False
        ),
        sa.Column(
            "refresh_token_hash",
    ...
    op.create_index(
        op.f("ix_auth_client_session_user_id"),
        "auth_client_session",
        ["user_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_auth_client_session_user_id"), table_name="auth_client_session"
    )
