...
def upgrade() -> None:
    ...
    sa.Column('id', auth_user_service.core.db_utils.UUIDChar(length=36), nullable=False),
    ...
    sa.Column('user_id', auth_user_service.core.db_utils.UUIDChar(length=36), nullable=False),
