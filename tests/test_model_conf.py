...
class TestModelConf:
    ...
    def test_set_scale_selector(self):
        ...
        assert self.obj.set_scale_selector(value=ScaleSelector.AUTO_SCALE) is True
        assert self.obj.has_scale_selector() is True
    ...
    def test_get_valid_model_names():
        ...
        assert ModelConf.get_valid_model_names() == [
            "edsr",
            "espcn",
            "fsrcnn",
            "lapsrn",
    ...
    def test_get_model_file_name():
        ...
        file_name = ModelConf.get_model_file_name(
            path="/bad/path", model_name="edsr", scale=2
        )
